            ...
            <div className="space-y-6">
              <Card className="shadow-lg">
                <CardContent className="p-6">
                  ...
                  <div className="text-3xl font-bold text-blue-600 mb-2">$2,000 - $8,000</div>
              ...
              <Card className="shadow-lg">
                <CardContent className="p-6">
                  ...
                  <div className="text-3xl font-bold text-green-600 mb-2">$8,000 - $25,000</div>
              ...
              <Card className="shadow-lg">
                <CardContent className="p-6">
                  ...
                  <div className="text-3xl font-bold text-purple-600 mb-2">$15,000 - $50,000</div>
